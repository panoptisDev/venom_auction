...
*/
export function executeLocal(config: string, account: string, message: string, utime: number, disable_signature_check: boolean): TransactionExecutorOutput;
/**
* @param {string} tvc
* @param {string} contract_abi
...
* @returns {string}
*/
export function encodeInternalMessage(src: string | undefined, dst: string, bounce: boolean, state_init: string | undefined, body: string | undefined, amount: string): string;
/**
...
export interface InitOutput {
  ...
  readonly executeLocal: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  ...
  readonly encodeInternalMessage: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hcb77729c6af9d376: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__hecba896d1563d223: (a: number, b: number, c: number, d: number) => void;
}
