        ...
        try {
          ...
          ${this.config.compilerPath} ${!this.options.disableIncludePath ? includePath : ""} ${path}`)).pipe((0, rxjs_1.map)(output => ({ output, contractFileName: (0, path_1.parse)(contractFileName).name, path })));
            ...
            (0, rxjs_1.catchError)(e => {
                ...
                return (0, rxjs_1.defer)(async () => (0, util_1.promisify)(child_process_1.exec)(`${this.config.linkerPath} compile -o ${(0, path_1.resolve)(this.options.build, `${contractFileName}.tvc`)} "${resolvedPathCode}" -a "${resolvedPathAbi}" ${lib}`)).pipe((0, rxjs_1.map)(tvmLinkerLog => {
                ...
                }), (0, rxjs_1.mergeMap)(tvcFile => (0, rxjs_1.defer)(() => (0, util_1.promisify)(fs_1.default.writeFile)((0, path_1.resolve)(this.options.build, `${contractFileName}.base64`), (0, utils_1.tvcToBase64)(fs_1.default.readFileSync(tvcFile)))).pipe((0, rxjs_1.catchError)(e => {
                    logger_1.logger.printError(e?.stderr?.toString());
                    return (0, rxjs_1.throwError)(undefined);
                }))));
